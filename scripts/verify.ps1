...
powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-cinder-chain-nonce-detail.ps1
...
powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-cinder-chain-nonce-properties.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-cinder-chain-nonce-golden.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-cinder_chain_nonce_mark-casebook.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }
