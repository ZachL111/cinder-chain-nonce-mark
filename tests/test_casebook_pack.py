"""Regression checks for the cinder-chain-nonce-mark casebook."""
...
from casebook.harness import assert_expected, cinder_chain_nonce_mark_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(cinder_chain_nonce_mark_summary(), assert_expected())
